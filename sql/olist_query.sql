...
SELECT
    ...
    CAST(SUM(is_late) * 100.0 / COUNT(*) AS DECIMAL(10,2)) AS late_delivery_rate_pct
...
GROUP BY review_score, delivery_state
ORDER BY review_score DESC, delivery_state;
